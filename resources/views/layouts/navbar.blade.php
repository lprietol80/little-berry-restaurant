<div class="navbar bg-base-100 shadow-lg">
    ...
    <div class="flex-1 hidden md:flex space-x-4">
      ...
      <a href="{{ route('bookings.index') }}" class="btn btn-ghost btn-sm">Reservas</a>
    ...
    <div class="dropdown dropdown-end">         
      ...
      <ul tabindex="0" class="mt-3 z-[1] p-2 shadow menu menu-sm dropdown-content bg-base-100 rounded-box w-52">
        ...
        <li>
          <form method="POST" action="{{ route('logout') }}">               @csrf               <a href="{{ route('logout') }}" onclick="event.preventDefault(); this.closest('form').submit();">Logout</a>
          </form>
        </li>
      </ul>
    </div>
